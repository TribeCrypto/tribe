...
Format: ```mngovernance prepare proposal-name url payment-count block-start tribe-address monthly-payment-tribe```
...
Format: ```mngovernance submit proposal-name url payment-count block-start tribe-address monthly-payment-tribe fee-tx```
...
The following RPC commands are supported:
 ...
 - mngovernance "command"... ( "passphrase" )
  ...
  - vote               - Vote on a proposal by single masternode (using tribe.conf setup)
