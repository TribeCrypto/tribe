...
Only requiring some minor changes is tribe.cpp.
...
Changes to tribe.cpp
----------------------
tribe.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
